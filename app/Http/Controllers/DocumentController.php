...
class DocumentController extends Controller
{
    ...
    public function deleteSelectedItems(Request $request, $id)
    {
        ...
        try {
            ...
            // Check if user is authorized to edit (only creator can edit)
            if (Auth::id() != $document->created_by) {
                return back()->with('error', 'You are not authorized to delete items from this document.');
            }
            ...
            // Log before deletion
            Log::info('Attempting to delete items', [
                'document_id' => $document->id,
                'document_no' => $document->document_no,
            ...
            // Log the deletion
            Log::info('Document items deleted successfully', [
                'document_no' => $document->document_no,
                'user_id' => auth()->id(),
                'user_name' => auth()->user()->name,
