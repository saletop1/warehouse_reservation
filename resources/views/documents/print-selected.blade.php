...
<head>
    ...
    <style>
        ...
        /* Style untuk info dokumen di kanan - sama dengan print.blade.php */
        .info-table td {
...
<body class="text-black">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <!-- Header - DISESUAIKAN dengan print.blade.php -->
                <div class="print-header compact-margin">
                    <div class="row">
                        ...
                        <div class="col-5 text-end">
                            ...
                            <div class="mt-1">
                                <!-- TABEL INFO - DISESUAIKAN dengan print.blade.php -->
                                <table class="table table-sm table-borderless compact-text" style="margin-bottom: 0; width: auto; float: right;">
                                    <tbody>
                                        <tr>
                                            <td class="info-label" style="padding: 1px; text-align: right;"><strong>Plant Request:</strong></td>
                                            <td class="info-value" style="padding: 1px;">{{ $document->plant }}</td>
                                        </tr>
                                        <tr>
                                            <td class="info-label" style="padding: 1px; text-align: right;"><strong>Plant Supply:</strong></td>
                                            <td class="info-value" style="padding: 1px;">
                                        ...
                                        <tr>
                                            <td class="info-label" style="padding: 1px; text-align: right;"><strong>Date:</strong></td>
                                            <td class="info-value" style="padding: 1px;">{{ \Carbon\Carbon::parse($document->created_at)->setTimezone('Asia/Jakarta')->format('d/m/Y') }}</td>
                                        </tr>
                                        <tr>
                                            <td class="info-label" style="padding: 1px; text-align: right;"><strong>Status:</strong></td>
                                            <td class="info-value" style="padding: 1px;">
                                        ...
                                        <tr>
                                            <td class="info-label" style="padding: 1px; text-align: right;"><strong>Selected Items:</strong></td>
                                            <td class="info-value" style="padding: 1px;">{{ count($items) }} items</td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <div class="mb-3 compact-margin">
                    @php
                        ...
                        // Calculate column widths based on which columns are visible - SAMA dengan print.blade.php
